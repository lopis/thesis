...
% For dictionary table with fixed column width
\usepackage{array}

% For bold faced code blocks
\usepackage{pxfonts}

% For compact enumarations
\usepackage{enumitem}

% For URL references in bibtex
\usepackage{hyperref}
...
\newcommand\plugin{MasSim2Dev}
\newcommand\pluginname{MAS Simulation to Development code convertion tool}
...
\lstset{framextopmargin=0pt,frame=lrbt}
\DeclareUnicodeCharacter{00A7}{\st}
%%%
...
\include{chapters/conversion_tool}
